...
export const metadata: Metadata = {
  title: "Consultas de Psicologia em Barcelos - Ricardo Linhares",
  description: "Consultas de Psicologia Clínica e Psicoterapia em Barcelos. Tratamento de ansiedade, depressão, pânico e outros problemas psicológicos.",
};
  ...
  return (
    <main className="flex flex-col min-h-screen  items-center justify-start  w-full z-0 overflow-hidden ">
        ...
        <p className="text-left leading-8 ">
          <cite>
          &ldquo;É o seu caminho e apenas seu. Os outros podem acompanhá-lo(a), mas ninguém pode andar por si&rdquo; </cite>
          - Rumi.
        </p>
      </div>
